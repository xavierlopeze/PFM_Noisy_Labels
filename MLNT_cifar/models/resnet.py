#This is the adapted code from https://github.com/LiJunnan1992/MLNT/blob/master/models/resnet.py
#This adapattion enables to use resnet34 with basic block forward propagation with weightss
...
class ResNet(nn.Module):
    ...
    def forward(self, x, weights=None, get_feat=None):
        if weights==None:
            ...
            x = F.avg_pool2d(x, 4) #self.avgpool(x)
